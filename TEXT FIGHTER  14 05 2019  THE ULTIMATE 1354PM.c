...
int emgspcom5 = 0, emagsup5 = 0, mspatt5 = 0, enspcomb6 = 0, bonrec = 0, magrec = 0, bonrec2 = 0, magrec2 = 0;
time_t t;
...
if (((diceM > 66) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && (hypsp2 < 1) && (enspcomb6 < 1))//was 20
{//&& (enemyhp < 5)) DICE E ORIGINALLY 16
{
...
if ((emgspcom == 1) && ((diceF > 32) && (diceB >= 5) && (diceB <= 6) && (diceM > 66)))
{
...
if (playerhp < 1)
{
printf("\n     AND A VERY POWERFUL MAGIC COMBO FINISH!\n\n");
}
}
if ((emgspcom5 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 6) && (diceM > 66)))
{
...
if ((emagsup5 > 0) && ((diceP > 42) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 48) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 66) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1) && (hypsp2 < 1)))// diceN at 80 vs 200 quite rare
{//
...
if ((emgspcom4 == 1) && ((diceN > 48) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 66) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0)))////////////////&& (playerhp > 0)) //&& (diceB >= ) && (diceB <= 6)))
{
...
if ((emgspcom3 == 1) && ((diceP > 42) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 48) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 66) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0) && (mspatt5 > 0))) //&& (playerhp > 0)) //&& (diceB >= ) && (diceB <= 6)))
{
if (playerhp > 0)
printf("\n");
