...
int spmag = 0, spmag2 = 0, magsp = 0, magsp2 = 0, normag = 0, magsp3 = 0, sumag2 = 0, sumag = 0, magcom = 0, magsp4 = 0, magsp5 = 0, consecvic5 = 0;
int diflev = 0, posdef = 0, posmag = 0, posbon = 0, bonchn = 0, bonchn2 = 0, cpusp = 0, consecvic4 = 0, spctrbon3 = 0, ultsp = 0, bonchn3 = 0;
int  ans6 = 1;
time_t t;
...
if ((consecvic2 < 1) && (spctrbon < 1) && (dice5 > dice6) && (magsp >= 0) && (magsp3 > 0) && (bonchn2 < 3) && (ultsp < 4))
{
...
{
printf("\nTHE CPU ULTRA SUPER SPECIAL COMBO!\n");
...
{
printf ("\n\nYou won with the Counter Bonus Attack!\n");
