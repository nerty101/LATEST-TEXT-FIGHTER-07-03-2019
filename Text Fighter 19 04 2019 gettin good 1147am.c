...
main()
{
int dice1, dice2, dice3, dice4, dice5, dice6, diceA, diceB, diceC, diceD, diceE, diceF, diceG, diceH, diceI, diceJ = 0, diceK = 0, diceL = 0;
...
int  ans6 = 1, sumag5 = 0, spmag5 = 0, spmag6 = 0, magchn = 0, posmag2 = 0, cpusp3 = 0, spctrdf = 0, spc = 0;
time_t t;
...
printf("           *********** Press (n) for Normal Attack   (m) for Magic Special   (s) for Special Attack ***********\n");
printf("           _________________________________________________________________________________________________\n\n");
printf("  ");
scanf (" %c", &choice);
if (choice == 'N')
...
{
{
dice1 = (rand() % 300 + cpusp) + 1;//was 6 7
if (diflev > 7)//was 4
dice1 = (rand() % 8) + 1;
if (diflev > 25)
dice1 = (rand() % 9) + 1;
...
if (choice == 'm')
{
dice3 = (rand() % 1300 + cpusp) + 1;//was 14 then 15 THEN 16? NOW 19 OR 20?????? now 18 300 test now 19 21 22 23 21 23 21 10 13 12 14
...
{
playerhp = (playerhp + 3);
printf("\n     You get the Magic Special!\n");
printf("     Player HP now at %d\n", playerhp);
cpusp = 0;
}
if ((dice3 > dice4) && (spmag > 2) && (spmag2 < 4) && (sumag2 != 1) && (magchn < 3))
{
playerhp = (playerhp + 6);
printf("\n     You get the Magic Special Bonus!\n");
...
{
printf("\n");
printf("     Only a Master could achieve something like this!\n\n");
}
break;
}
...
printf("\n");
if (cpusp > 1)
printf("     With %d Special Attacks in as many rounds!", cpusp);
...
if (cpusp > 1)
printf("\n     With %d Special Attacks in as many rounds!", cpusp);
...
printf("\n     CPU executes a Magic Counter Attack!\n");
printf("     Player HP at %d\n", playerhp);
}
}
if (dice3 == dice4)
...
{
{
dice5 = (rand() % 300 + (diflev + cpusp));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 -1
...
if (ctr < 2)
{
printf("     You won in the first round!\n\n");
...
printf("\n     CPU executes a Special Counter Attack!\n");
printf("     Player HP at %d\n", playerhp);
}
...
//printf("\n");
if (cpusp > 1)
printf("\n     With Special Attacks in the last %d consecutive rounds!\n", cpusp);
printf("     You won with the Counter!\n");
if ((ctr > 3) && (cpusp > 1))
printf("\n");
//++spc;
if ((cpusp < 2) && (ctr < 4))   // THIS IS GOOD, JA?
printf("\n");
printf("     Good defence!\n\n");
break;
}
...
{
if (ctr < 4)
printf("     An early ending to the match!!\n");
if (cpusp > 1)
printf("\n    With consecutive Special Attacks in the last %d rounds!\n", cpusp);
...
if ((choice == 's') && (diceB > 6) && (diceH < 17) && (enemyhp > 0)) //diceH at 17 test more like 6 ????
{
...
printf("\n\n        -Go for some moves!");
if ((cpusp == 0) && (ctr > 10) && (playerhp < 12) && ((diceK > 35) && (diceK < 44)))
printf("\n\n        -Hang in there!");
if ((cpusp == 0) && (diceK >= 43))
printf("\n\n        -Never give in!");
}
