...
printf("\n");
//if ((ctr < 7) & (cpusp > 1))
//if (((ctr >= 5) || (ctr <= 4)) &&  (cpusp < 2))
//if (((ctr > 6) & (cpusp > 1)) || ((ctr > 5) & (cpusp > 1)))
...
//if ((cpusp < 2) && (ctr > 4))   ///change or keep this way for 3 lines, then 2 for no early win, no special round chain? seems so
//printf("\n");
if ((cpusp < 2) && (ctr < 5))
printf("\n");
if ((cpusp > 1) && (ctr > 4))
