...
if (choice == 'm')
{
dice3 = (rand() % 133 + cpusp + diflev) + 1;//was 140
...
if ((emgspcom == 1) && ((diceF > 32) && (diceB >= 5) && (diceB <= 6) && (diceM > 70)))
{
if (playerhp > 0)
printf("\n");
...
if ((emgspcom5 == 1) && ((diceE > 16) && (diceB >= 4) && (diceB <= 6) && (diceM > 70)))
{
if (playerhp > 0)
printf("\n");
...
if  ((emagsup > 0) && ((diceN > 50) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1)))
{//&& (enemyhp < 5)) DICE E ORIGINALLY 16
playerhp = (playerhp - 1); //6
...
if  ((emagsup5 > 0) && ((diceP > 42) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 50) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 70) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1) && (hypsp2 < 1)))// diceN at 80 vs 200 quite rare
{//
...
if ((emgspcom4 == 1) && ((diceN > 50) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 70) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0)))////////////////&& (playerhp > 0)) //&& (diceB >= ) && (diceB <= 6)))
{
if (playerhp > 0)
printf("\n");
...
if ((emgspcom3 == 1) && ((diceP > 42) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 50) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 70) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0) && (mspatt5 > 0))) //&& (playerhp > 0)) //&& (diceB >= ) && (diceB <= 6)))
{
if (playerhp > 0)
printf("\n");
